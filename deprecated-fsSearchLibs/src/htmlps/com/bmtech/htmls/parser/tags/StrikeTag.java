...
//
// $Source: /liying/bmt_base/src/htmlps/com/bmtech/htmls/parser/tags/StrikeTag.java,v $
// $Author: liying $
 ...
 * A title tag.
 */
public class StrikeTag extends CompositeTag
{
    /**
	 * 
	 */
     ...
     */
    private static final String[] mIds = new String[] {"STRIKE"};

    /**
     * The set of tag names that indicate the end of this tag.
     */
    private static final String[] mEnders = new String[] {"STRIKE","BODY"};
