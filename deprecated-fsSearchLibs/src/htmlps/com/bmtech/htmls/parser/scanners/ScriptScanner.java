...
//$Source: /liying/bmt_base/src/htmlps/com/bmtech/htmls/parser/scanners/ScriptScanner.java,v $
//$Author: liying $
...
CompositeTagScanner
{
	...
	throws ParserException
	{
		...
		node = lexer.nextNode4Script();// (false);
		int end=lexer.getPosition();
		content = lexer.makeString(start,end-9);
		position =end;
