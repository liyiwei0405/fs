...
public class Plots implements org.apache.thrift.TBase<Plots, Plots._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("Plots");
  ...
  private static final org.apache.thrift.protocol.TField PLOTS_FIELD_DESC = new org.apache.thrift.protocol.TField("plots", org.apache.thrift.protocol.TType.STRING, (short)2);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new PlotsStandardSchemeFactory());
    schemes.put(TupleScheme.class, new PlotsTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(Plots.class, metaDataMap);
  }
  ...
  public Plots deepCopy() {
    return new Plots(this);
  }
  ...
  public Plots setMediaId(int mediaId) {
    this.mediaId = mediaId;
    setMediaIdIsSet(true);
    return this;
  }
  ...
  public Plots setPlots(String plots) {
    this.plots = plots;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof Plots)
      return this.equals((Plots)that);
    return false;
  }

  public boolean equals(Plots that) {
    if (that == null)
      return false;
  ...
  public int compareTo(Plots other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    Plots typedOther = (Plots)other;
  ...
  private static class PlotsStandardSchemeFactory implements SchemeFactory {
    public PlotsStandardScheme getScheme() {
      return new PlotsStandardScheme();
    }
  }

  private static class PlotsStandardScheme extends StandardScheme<Plots> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, Plots struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Plots struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class PlotsTupleSchemeFactory implements SchemeFactory {
    public PlotsTupleScheme getScheme() {
      return new PlotsTupleScheme();
    }
  }

  private static class PlotsTupleScheme extends TupleScheme<Plots> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, Plots struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, Plots struct) throws org.apache.thrift.TException {
