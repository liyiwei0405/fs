...
public class MysqlExportHelper {
	...
	public MysqlExportHelper(LineWriter writeTo){
		this.cr = new ConfigReader(MediaFactory.mysqlClientConfigFile, "fs_media");
	...
	public void export(Map<Integer, List<Integer>> mediaToRelatedVideos) throws Exception{
		...
		try {
			...
			String sql_fs_web_playinfo = "SELECT mediaid, isdisplay FROM fs_web_playinfo";
			ResultSet rs_fs_web_playinfo = statement.executeQuery(sql_fs_web_playinfo);
			this.mediaToIsdisplays = genMap(rs_fs_web_playinfo, "isdisplay");
//			System.out.println(mediaToIsdisplays);
			String sql_fsmedia = "SELECT a.mediaid, a.name_cn, a.name_en, a.name_ot, a.name_sn, a.displaytype, a.imagefilepath, a.coverpicid, a.plots, a.country, a.releasedate, a.releaseinfo, a.tag4editor, a.tactics, a.isplay, a.webplay, a.supporttype, a.ordering, a.issue, a.deleted, a.ta_0, a.ta_1, a.ta_2, a.ta_3, a.ta_4, a.ta_5, a.ta_6, a.ta_7, a.ta_8, a.ta_9, a.copyright, b.playnum, b.playafternum, b.karma, b.votenum, b.wantseenum, a.program_type " +
