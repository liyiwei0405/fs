...
public class SortRetrieve implements org.apache.thrift.TBase<SortRetrieve, SortRetrieve._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("SortRetrieve");
  ...
  static {
    schemes.put(StandardScheme.class, new SortRetrieveStandardSchemeFactory());
    schemes.put(TupleScheme.class, new SortRetrieveTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(SortRetrieve.class, metaDataMap);
  }
   ...
   */
  public SortRetrieve(SortRetrieve other) {
  ...
  public SortRetrieve deepCopy() {
    return new SortRetrieve(this);
  }
  ...
  public SortRetrieve setField(String field) {
    this.field = field;
    return this;
  }
  ...
  public SortRetrieve setAsc(boolean asc) {
    this.asc = asc;
    setAscIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof SortRetrieve)
      return this.equals((SortRetrieve)that);
    return false;
  }

  public boolean equals(SortRetrieve that) {
    if (that == null)
      return false;
  ...
  public int compareTo(SortRetrieve other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    SortRetrieve typedOther = (SortRetrieve)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("SortRetrieve(");
    boolean first = true;
  ...
  private static class SortRetrieveStandardSchemeFactory implements SchemeFactory {
    public SortRetrieveStandardScheme getScheme() {
      return new SortRetrieveStandardScheme();
    }
  }

  private static class SortRetrieveStandardScheme extends StandardScheme<SortRetrieve> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, SortRetrieve struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SortRetrieve struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class SortRetrieveTupleSchemeFactory implements SchemeFactory {
    public SortRetrieveTupleScheme getScheme() {
      return new SortRetrieveTupleScheme();
    }
  }

  private static class SortRetrieveTupleScheme extends TupleScheme<SortRetrieve> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, SortRetrieve struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, SortRetrieve struct) throws org.apache.thrift.TException {
