 ...
 *
 */
public abstract class AbstractSpanableMediaNameTokenizer  extends AbstractMediaNameTokenizerWithoutScores{
	...
	public AbstractSpanableMediaNameTokenizer(Reader reader) {
		super(reader);
	}
	@Override
