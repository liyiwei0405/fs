    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, QueryStruct struct) throws org.apache.thrift.TException {
      ...
      if (struct.weights != null) {
        oprot.writeFieldBegin(WEIGHTS_FIELD_DESC);
        {
          ...
          for (FieldWeight _iter12 : struct.weights)
          {
            _iter12.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.filters != null) {
        oprot.writeFieldBegin(FILTERS_FIELD_DESC);
        {
          ...
          for (FieldFilter _iter13 : struct.filters)
          {
            _iter13.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.sortFields != null) {
        oprot.writeFieldBegin(SORT_FIELDS_FIELD_DESC);
        {
          ...
          for (SortBy _iter14 : struct.sortFields)
          {
            _iter14.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.rqs != null) {
        oprot.writeFieldBegin(RQS_FIELD_DESC);
        {
          ...
          for (RangeQuery _iter15 : struct.rqs)
          {
            _iter15.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetWeights()) {
        {
          ...
          for (FieldWeight _iter16 : struct.weights)
          {
            _iter16.write(oprot);
          }
        }
      ...
      if (struct.isSetFilters()) {
        {
          ...
          for (FieldFilter _iter17 : struct.filters)
          {
            _iter17.write(oprot);
          }
        }
      ...
      if (struct.isSetSortFields()) {
        {
          ...
          for (SortBy _iter18 : struct.sortFields)
          {
            _iter18.write(oprot);
          }
        }
      ...
      if (struct.isSetRqs()) {
        {
          ...
          for (RangeQuery _iter19 : struct.rqs)
          {
            _iter19.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.weights = new ArrayList<FieldWeight>(_list20.size);
          for (int _i21 = 0; _i21 < _list20.size; ++_i21)
          {
            FieldWeight _elem22; // required
            _elem22 = new FieldWeight();
            _elem22.read(iprot);
            struct.weights.add(_elem22);
          }
        }
        struct.setWeightsIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.filters = new ArrayList<FieldFilter>(_list23.size);
          for (int _i24 = 0; _i24 < _list23.size; ++_i24)
          {
            FieldFilter _elem25; // required
            _elem25 = new FieldFilter();
            _elem25.read(iprot);
            struct.filters.add(_elem25);
          }
        }
        struct.setFiltersIsSet(true);
      }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.sortFields = new ArrayList<SortBy>(_list26.size);
          for (int _i27 = 0; _i27 < _list26.size; ++_i27)
          {
            SortBy _elem28; // required
            _elem28 = new SortBy();
            _elem28.read(iprot);
            struct.sortFields.add(_elem28);
          }
        }
        struct.setSortFieldsIsSet(true);
      }
      if (incoming.get(4)) {
        {
          ...
          struct.rqs = new ArrayList<RangeQuery>(_list29.size);
          for (int _i30 = 0; _i30 < _list29.size; ++_i30)
          {
            RangeQuery _elem31; // required
            _elem31 = new RangeQuery();
            _elem31.read(iprot);
            struct.rqs.add(_elem31);
          }
        }
        struct.setRqsIsSet(true);
      }
