...
class mail
{
	 ...
	 */
	public static function send_mail($subject = "",$body = "",$contacter)
	{
		$config = self:: get_send_mail_info();
		$to = $contacter;
...
//		$mail->SMTPSecure = "ssl";                 // 安全协议
	...
	private  static function get_send_mail_info()
	{
		return array(
				'userName' => 'rpc-health@funshion.com',
				'passWord' => 'wt9YyJh_3D',
			//	'userName' => 'seoatdd@gmail.com',
			//	'passWord' => 'funshion',
		);
	}
}
