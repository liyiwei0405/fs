...
public class UGCVideoRecordTest {
	...
	public static void beforeClass() throws IOException{
		ConfigReader cr = VideoletFactory.getConfig(VideoletFactory.UGC);
		...
		BasicDBObject qPubStatus = new BasicDBObject("_id", 755927);
	...
	public void testGetVideoId() {
		assertEquals("videoId mismatch", record.videoId, 755927);
	}
	@Ignore("not implement now")
	@Test
	...
	public void testGetModifyDate() {
		...
		assertEquals("get modifytime fail", modifytime, 1327689914);
	}
	@Ignore("not implement now")
	@Test
