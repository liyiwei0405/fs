...
import com.funshion.search.utils.c2j.cTypes.U8;


public abstract class Struct{	
	/**
	 * init the message .
	 * actually work like malloc in c,memory allocation
	 */
	...
	/**
	 * copy bytes view char[] as byte[].
	 * if the index exceed cs.length(),we will stop copying
	 * @param cs
	 * @param iPos
	 * @param bs
	 * @param dPos
	 ...
	 * if the index exceed cs.length(),we will stop copyeing
	 * @param cs
	 * @param iPos
	 * @param bs
	 * @param dPos
