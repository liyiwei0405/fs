...
public class Counter<T> {
	...
	protected HashMap<T, CounterNum>map = new HashMap<T, CounterNum>();
	...
	public void count(HashMap<T, CounterNum>map,T key, CounterNum num){
		count(map, key, num.intValue());
	}
	public int count(HashMap<T, CounterNum>map,T key, int num){
	...
	public List<Entry<T, CounterNum>> topEntry(HashMap<T, CounterNum> map, int num){
