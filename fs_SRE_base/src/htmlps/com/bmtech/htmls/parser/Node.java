...
//
// $Source: /liying/bmt_base/src/htmlps/com/bmtech/htmls/parser/Node.java,v $
// $Author: liying $
 ...
 * {@link com.bmtech.htmls.parser.lexer.Lexer} or {@link Parser}, but each of the types
        ...
        Cloneable
{
     ...
     * current node is a {@link com.bmtech.htmls.parser.tags.CompositeTag}, and going
     ...
     * {@link com.bmtech.htmls.parser.lexer.Lexer}.
     * Currently, the object returned from this method can be safely cast to a
     * {@link com.bmtech.htmls.parser.tags.CompositeTag}, but this behaviour should not
